...
;
    ...
    Do(function(){
        ...
        $("#comments").delegate(".comment-report a", 'click', function (e) {
            ...
            var url = "https://www.douban.com/group/topic/258673611/?".concat(opt, '=', cid);
            var type = ['comment']
